...
const dict: Record<Lang, Dict> = {
  en: {
    ...
    developerInfoRole: "Dr Pavlo Lykhovyd — Principal Researcher",
    developerInfoOrg: "Institute of Water Problems and Land Reclamation of NAAS, Ukraine",
  ...
  ua: {
    ...
    developerInfoRole: "д-р с.-г. наук Павло Лиховид — головний науковий співробітник",
    developerInfoOrg: "Інститут водних проблем і меліорації НААН, Україна",
